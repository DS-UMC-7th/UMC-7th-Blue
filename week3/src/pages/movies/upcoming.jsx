...
const UpComing = () => {
  ...
  // const { data: movies, isLoading, isError } = useQueryFetch('/movie/upcoming');
  ...
  //   fetchNextPage,
  //   hasNextPage
  //   } = useInfiniteQueryFetch('/movie/upcoming');
  ...
  const { data: movies, isLoading, isError } = useQueryFetch('upcoming', page);
